...
public class User implements Serializable{
  ...
  public JSONObject getJSON(){
    ...
    */
    ...
    jObj.put( DATE_OF_CHANGE_KEY, _changeDate );
  ...
  public boolean changePassword( byte[] newPassword, 
                        String changerName, String newChangeDate ){
  ...
  public boolean attrSearch( Pattern queryPattern, String attrName ){
    if ( USERNAME_KEY.equals(attrName))
      return (queryPattern.matcher(_username)).find();

    if ( CHANGE_MAKER_KEY.equals(attrName))
      return (queryPattern.matcher(_changeMakerName)).find();
    
    if ( DATE_OF_CHANGE_KEY.equals(attrName))
      return (queryPattern.matcher(_changeDate)).find();
