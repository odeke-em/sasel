...
public class Preparation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		//Handling restart changes eg screen rotation, deprecated as of Wednesday 28th August 2013 -- 5:40PM
		...
		dataSpinnerHandler = new Handler(){
			...
			public void handleMessage(Message msg){
				...
				if (inMsg.equals(UPLOAD_STARTED) || inMsg.equals(DOWNLOAD_STARTED)){
					...
					toggleSpinner(false);
				}else if (inMsg.equals(DOWNLOAD_FAILED)){
					toggleSpinner(false);
				}
			}
		};
				...
				if (extras != null){
					...
					if (returnedData != null){
						...
						builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								Intent changeKeysIntent = new Intent(dataContext, IvEncryptionKeySelectActivity.class);
	...
	public void openSecreteBook(View v){
		//toggleSpinner(true);
							...
							try{
								...
								if (serverArray == null){
									...
									for (Object serverData : serverArray){
										//System.out.println("serverData "+(String)serverData);
	...
	public void changeEncryptionCredentials(View v){
		Intent keyChangeIntent = new Intent(v.getContext(), IvEncryptionKeySelectActivity.class);
